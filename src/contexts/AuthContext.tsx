...
const mockUsers = [
  ...
  { id: '4', name: 'Admin', email: 'admin', password: '123456' },
  { id: '2', name: 'HR Manager', email: 'hr@company.com', password: '123456' },
  { id: '3', name: 'John Employee', email: 'john@company.com', password: '123456' },
];

// Separate roles table (simulating database structure)
const mockUserRoles = [
  { userId: '1', role: 'admin' as UserRole },
  { userId: '4', role: 'admin' as UserRole },
